...
data.clock = 'Standard'  -- FIXED: Added missing clock setting (prevents script/main.lua:727 crash)
data.date = 'Type A'  -- FIXED: Added missing date setting (prevents similar crashes)
...
data.debugMode = true  -- FIXED: Enable debug mode for troubleshooting
data.usxChar = false
